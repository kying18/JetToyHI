...
# export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/afs/cern.ch/sw/lcg/external/MCGenerators_lcgcmt67c/pythia8/226/x86_64-slc6-gcc48-opt/lib
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/data/programs/pythia/pythia8240/lib/:/data/programs/fastjet/install/lib/
